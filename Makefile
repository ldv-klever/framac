...
src/libraries/stdlib/integer.cmx: OFLAGS:=$(OFLAGS) -w -58
...
src/kernel_services/plugin_entry_points/dynamic.cmx: OFLAGS:=$(OFLAGS) -w -58
...
# Optionnaly define them as empty to silence warnings about undefined variables
GITVERSION ?=
CLIENT ?=
