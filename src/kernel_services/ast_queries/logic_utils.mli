...
*)
val mk_cast: ?loc:location -> ?force:bool -> ?overflow:overflow_treatment -> typ -> term -> term
...
val is_same_astraver_pragma : astraver_pragma -> astraver_pragma -> bool
...
val is_astraver_pragma : code_annotation -> bool
