...
open Parsing;;
let _ = parse_error;;
# 30 "src/plugins/aorai/promelaparser.mly"
open Promelaast
open Bool3
...
# 41 "src/plugins/aorai/promelaparser.ml"
let yytransl_const = [|
  257 (* PROMELA_OR *);
  258 (* PROMELA_AND *);
  259 (* PROMELA_NOT *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 69 "src/plugins/aorai/promelaparser.mly"
                                                                 ( 
            let states=
...
# 254 "src/plugins/aorai/promelaparser.ml"
               : 'state))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'label) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'state_labels) in
    Obj.repr(
# 133 "src/plugins/aorai/promelaparser.mly"
                             ( 
            let (stl1,trl1)=_1 in
            let (stl2,trl2)=_2 in
              (stl1@stl2,trl1@trl2) 
        )
# 266 "src/plugins/aorai/promelaparser.ml"
               : 'state_labels))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'label) in
    Obj.repr(
# 138 "src/plugins/aorai/promelaparser.mly"
                ( _1 )
# 273 "src/plugins/aorai/promelaparser.ml"
               : 'state_labels))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    Obj.repr(
# 142 "src/plugins/aorai/promelaparser.mly"
                                      (
          begin
...
# 328 "src/plugins/aorai/promelaparser.ml"
               : 'label))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'transitions) in
    Obj.repr(
# 195 "src/plugins/aorai/promelaparser.mly"
                                            ( (_2,false) )
# 335 "src/plugins/aorai/promelaparser.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    Obj.repr(
# 196 "src/plugins/aorai/promelaparser.mly"
                       ( ([],false) )
# 341 "src/plugins/aorai/promelaparser.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    Obj.repr(
# 197 "src/plugins/aorai/promelaparser.mly"
                        ( ([],true) )
# 347 "src/plugins/aorai/promelaparser.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    Obj.repr(
# 198 "src/plugins/aorai/promelaparser.mly"
                                                                   ( ([],true) )
# 353 "src/plugins/aorai/promelaparser.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'transitions) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'transition) in
    Obj.repr(
# 203 "src/plugins/aorai/promelaparser.mly"
                                 ( _1@[_2] )
# 361 "src/plugins/aorai/promelaparser.ml"
               : 'transitions))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'transition) in
    Obj.repr(
# 204 "src/plugins/aorai/promelaparser.mly"
                     ( [_1] )
# 368 "src/plugins/aorai/promelaparser.ml"
               : 'transitions))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 3 : 'guard) in
    let _5 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 208 "src/plugins/aorai/promelaparser.mly"
                                                                                    (
          let s=
            try
...
# 387 "src/plugins/aorai/promelaparser.ml"
               : 'transition))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 223 "src/plugins/aorai/promelaparser.mly"
                                 ( POr(PCall (_1,None), PReturn _1) )
# 394 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 224 "src/plugins/aorai/promelaparser.mly"
                         ( PCall (_1,None) )
# 401 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 225 "src/plugins/aorai/promelaparser.mly"
                           ( PReturn _1 )
# 408 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    Obj.repr(
# 226 "src/plugins/aorai/promelaparser.mly"
                       ( PTrue )
# 414 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    Obj.repr(
# 227 "src/plugins/aorai/promelaparser.mly"
                        ( PFalse )
# 420 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'guard) in
    Obj.repr(
# 228 "src/plugins/aorai/promelaparser.mly"
                            ( PNot _2 )
# 427 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'guard) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'guard) in
    Obj.repr(
# 229 "src/plugins/aorai/promelaparser.mly"
                                  ( PAnd (_1,_3) )
# 435 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'guard) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'guard) in
    Obj.repr(
# 230 "src/plugins/aorai/promelaparser.mly"
                                 ( POr (_1,_3) )
# 443 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'guard) in
    Obj.repr(
# 231 "src/plugins/aorai/promelaparser.mly"
                                              ( _2 )
# 450 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 233 "src/plugins/aorai/promelaparser.mly"
            ( PRel (Logic_ptree.Neq,PVar _1,PCst(Logic_ptree.IntConstant "0")) )
# 457 "src/plugins/aorai/promelaparser.ml"
               : 'guard))
(* Entry promela *)
