...
open Parsing;;
let _ = parse_error;;
# 30 "src/plugins/aorai/ltlparser.mly"
open Promelaast
open Logic_ptree
...
# 52 "src/plugins/aorai/ltlparser.ml"
let yytransl_const = [|
  257 (* LTL_TRUE *);
  258 (* LTL_FALSE *);
  259 (* LTL_LPAREN *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 84 "src/plugins/aorai/ltlparser.mly"
                      ((_1,observed_expressions))
# 325 "src/plugins/aorai/ltlparser.ml"
               : (Ltlast.formula * (string, (Logic_ptree.relation *  Promelaast.expression * Promelaast.expression)) Hashtbl.t)))
; (fun __caml_parser_env ->
    Obj.repr(
# 90 "src/plugins/aorai/ltlparser.mly"
            (Ltlast.LTrue)
# 331 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    Obj.repr(
# 92 "src/plugins/aorai/ltlparser.mly"
            (Ltlast.LFalse)
# 337 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'formula) in
    Obj.repr(
# 94 "src/plugins/aorai/ltlparser.mly"
            ( _2 )
# 344 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 97 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LGlobally(_2) )
# 351 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 99 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LFatally(_2) )
# 358 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'formula) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 101 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LUntil(_1,_3) )
# 366 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'formula) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 103 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LRelease(_1,_3) )
# 374 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 105 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LNext(_2) )
# 381 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'formula) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 108 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LOr(_1,_3) )
# 389 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'formula) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 110 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LAnd(_1,_3) )
# 397 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 112 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LNot(_2) )
# 404 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'formula) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 114 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LImplies(_1,_3) )
# 412 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'formula) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'formula) in
    Obj.repr(
# 116 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LIff(_1,_3) )
# 420 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _3 = (Parsing.peek_val __caml_parser_env 1 : string) in
    Obj.repr(
# 119 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LCall(_3))
# 427 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _3 = (Parsing.peek_val __caml_parser_env 1 : string) in
    Obj.repr(
# 121 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LReturn(_3))
# 434 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _3 = (Parsing.peek_val __caml_parser_env 1 : string) in
    Obj.repr(
# 123 "src/plugins/aorai/ltlparser.mly"
            ( Ltlast.LCallOrReturn(_3))
# 441 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'logic_relation) in
    Obj.repr(
# 127 "src/plugins/aorai/ltlparser.mly"
            (
              let id = get_fresh_ident () in
                Hashtbl.add observed_expressions id _1;
                Ltlast.LIdent(id)
            )
# 452 "src/plugins/aorai/ltlparser.ml"
               : 'formula))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 135 "src/plugins/aorai/ltlparser.mly"
                                                ( Eq, _1 , _3)
# 460 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 136 "src/plugins/aorai/ltlparser.mly"
                                                ( Lt, _1, _3 )
# 468 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 137 "src/plugins/aorai/ltlparser.mly"
                                                ( Gt, _1, _3 )
# 476 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 138 "src/plugins/aorai/ltlparser.mly"
                                                ( Le, _1, _3 )
# 484 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 139 "src/plugins/aorai/ltlparser.mly"
                                                ( Ge, _1, _3 )
# 492 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 140 "src/plugins/aorai/ltlparser.mly"
                                                ( Neq, _1, _3 )
# 500 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 141 "src/plugins/aorai/ltlparser.mly"
                         ( Neq, _1, PCst (IntConstant "0") )
# 507 "src/plugins/aorai/ltlparser.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 145 "src/plugins/aorai/ltlparser.mly"
                                                     ( PBinop(Badd,_1,_3) )
# 515 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 146 "src/plugins/aorai/ltlparser.mly"
                                                      ( PBinop(Bsub,_1,_3) )
# 523 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation_mul) in
    Obj.repr(
# 147 "src/plugins/aorai/ltlparser.mly"
                             ( _1 )
# 530 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 152 "src/plugins/aorai/ltlparser.mly"
                                                     ( PBinop(Bdiv,_1,_3) )
# 538 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 153 "src/plugins/aorai/ltlparser.mly"
                                                      ( PBinop(Bmul,_1,_3) )
# 546 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 154 "src/plugins/aorai/ltlparser.mly"
                                                        ( PBinop(Bmod,_1,_3))
# 554 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 155 "src/plugins/aorai/ltlparser.mly"
                          ( _1 )
# 561 "src/plugins/aorai/ltlparser.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 160 "src/plugins/aorai/ltlparser.mly"
                  ( PCst (IntConstant _1) )
# 568 "src/plugins/aorai/ltlparser.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 161 "src/plugins/aorai/ltlparser.mly"
                            ( PUnop (Uminus,PCst (IntConstant _2)) )
# 575 "src/plugins/aorai/ltlparser.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access) in
    Obj.repr(
# 162 "src/plugins/aorai/ltlparser.mly"
                 ( _1 )
# 582 "src/plugins/aorai/ltlparser.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'arith_relation) in
    Obj.repr(
# 163 "src/plugins/aorai/ltlparser.mly"
                                               ( _2 )
# 589 "src/plugins/aorai/ltlparser.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'access) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 169 "src/plugins/aorai/ltlparser.mly"
                                           ( PField (PUnop(Ustar,_1),_3) )
# 597 "src/plugins/aorai/ltlparser.ml"
               : 'access))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'access) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 170 "src/plugins/aorai/ltlparser.mly"
                                   ( PField(_1,_3) )
# 605 "src/plugins/aorai/ltlparser.ml"
               : 'access))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access_array) in
    Obj.repr(
# 171 "src/plugins/aorai/ltlparser.mly"
                       (_1)
# 612 "src/plugins/aorai/ltlparser.ml"
               : 'access))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 175 "src/plugins/aorai/ltlparser.mly"
            ( PArrget(_1,_3) )
# 620 "src/plugins/aorai/ltlparser.ml"
               : 'access_array))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access_leaf) in
    Obj.repr(
# 176 "src/plugins/aorai/ltlparser.mly"
                      (_1)
# 627 "src/plugins/aorai/ltlparser.ml"
               : 'access_array))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'access) in
    Obj.repr(
# 180 "src/plugins/aorai/ltlparser.mly"
                             ( PUnop (Uamp,_2) )
# 634 "src/plugins/aorai/ltlparser.ml"
               : 'access_leaf))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'access) in
    Obj.repr(
# 181 "src/plugins/aorai/ltlparser.mly"
                          ( PUnop (Ustar, _2 ) )
# 641 "src/plugins/aorai/ltlparser.ml"
               : 'access_leaf))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 182 "src/plugins/aorai/ltlparser.mly"
                    ( PVar _1 )
# 648 "src/plugins/aorai/ltlparser.ml"
               : 'access_leaf))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'access) in
    Obj.repr(
# 183 "src/plugins/aorai/ltlparser.mly"
                                       ( _2 )
# 655 "src/plugins/aorai/ltlparser.ml"
               : 'access_leaf))
(* Entry ltl *)
