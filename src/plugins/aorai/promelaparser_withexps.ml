...
open Parsing;;
let _ = parse_error;;
# 30 "src/plugins/aorai/promelaparser_withexps.mly"
open Logic_ptree
open Promelaast
open Bool3
...
# 58 "src/plugins/aorai/promelaparser_withexps.ml"
let yytransl_const = [|
  257 (* PROMELA_OR *);
  258 (* PROMELA_AND *);
  259 (* PROMELA_NOT *);
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 80 "src/plugins/aorai/promelaparser_withexps.mly"
                                                                 ( 
            let states=
...
# 300 "src/plugins/aorai/promelaparser_withexps.ml"
               : Promelaast.parsed_automaton))
; (fun __caml_parser_env ->
    let _3 = (Parsing.peek_val __caml_parser_env 3 : 'states) in
    Obj.repr(
# 94 "src/plugins/aorai/promelaparser_withexps.mly"
                                                 (
            let states=
              Hashtbl.fold (fun _ st l -> 
                if st.acceptation=Undefined || st.init=Undefined then
            ...
            in
            (states , _3) )
# 318 "src/plugins/aorai/promelaparser_withexps.ml"
               : Promelaast.parsed_automaton))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'states) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'state) in
    Obj.repr(
# 109 "src/plugins/aorai/promelaparser_withexps.mly"
                                         ( _1@_3 )
# 326 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'states))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'state) in
    Obj.repr(
# 110 "src/plugins/aorai/promelaparser_withexps.mly"
                ( _1 )
# 333 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'states))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'state_labels) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'state_body) in
    Obj.repr(
# 114 "src/plugins/aorai/promelaparser_withexps.mly"
                                  (
          let (stl,trans)=_1 in
...
# 365 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'label) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'state_labels) in
    Obj.repr(
# 142 "src/plugins/aorai/promelaparser_withexps.mly"
                             ( 
            let (stl1,trl1)=_1 in
            let (stl2,trl2)=_2 in
              (stl1@stl2,trl1@trl2) 
        )
# 377 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state_labels))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'label) in
    Obj.repr(
# 147 "src/plugins/aorai/promelaparser_withexps.mly"
                ( _1 )
# 384 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state_labels))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    Obj.repr(
# 151 "src/plugins/aorai/promelaparser_withexps.mly"
                                      (
          begin
...
# 443 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'label))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'transitions) in
    Obj.repr(
# 208 "src/plugins/aorai/promelaparser_withexps.mly"
                                            ( (_2,false) )
# 450 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    Obj.repr(
# 209 "src/plugins/aorai/promelaparser_withexps.mly"
                       ( ([],false) )
# 456 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    Obj.repr(
# 210 "src/plugins/aorai/promelaparser_withexps.mly"
                        ( ([],true) )
# 462 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    Obj.repr(
# 211 "src/plugins/aorai/promelaparser_withexps.mly"
                                                                   ( ([],true) )
# 468 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'state_body))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'transitions) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'transition) in
    Obj.repr(
# 216 "src/plugins/aorai/promelaparser_withexps.mly"
                                 ( _1@[_2] )
# 476 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'transitions))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'transition) in
    Obj.repr(
# 217 "src/plugins/aorai/promelaparser_withexps.mly"
                     ( [_1] )
# 483 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'transitions))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 3 : 'guard) in
    let _5 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 222 "src/plugins/aorai/promelaparser_withexps.mly"
                                                       (
          let s=
            try
...
# 502 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'transition))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 237 "src/plugins/aorai/promelaparser_withexps.mly"
                                 ( POr(PCall (_1,None), PReturn _1) )
# 509 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 238 "src/plugins/aorai/promelaparser_withexps.mly"
                         ( PCall (_1,None) )
# 516 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 239 "src/plugins/aorai/promelaparser_withexps.mly"
                           ( PReturn _1 )
# 523 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    Obj.repr(
# 240 "src/plugins/aorai/promelaparser_withexps.mly"
                       ( PTrue )
# 529 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    Obj.repr(
# 241 "src/plugins/aorai/promelaparser_withexps.mly"
                        ( PFalse )
# 535 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'guard) in
    Obj.repr(
# 242 "src/plugins/aorai/promelaparser_withexps.mly"
                            ( PNot _2 )
# 542 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'guard) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'guard) in
    Obj.repr(
# 243 "src/plugins/aorai/promelaparser_withexps.mly"
                                  ( PAnd (_1,_3) )
# 550 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'guard) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'guard) in
    Obj.repr(
# 244 "src/plugins/aorai/promelaparser_withexps.mly"
                                 ( POr (_1,_3) )
# 558 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'guard) in
    Obj.repr(
# 245 "src/plugins/aorai/promelaparser_withexps.mly"
                                              ( _2 )
# 565 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'logic_relation) in
    Obj.repr(
# 246 "src/plugins/aorai/promelaparser_withexps.mly"
                         ( _1 )
# 572 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'guard))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 250 "src/plugins/aorai/promelaparser_withexps.mly"
                                                    ( PRel(Eq, _1, _3) )
# 580 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 251 "src/plugins/aorai/promelaparser_withexps.mly"
                                                    ( PRel(Lt, _1, _3) )
# 588 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 252 "src/plugins/aorai/promelaparser_withexps.mly"
                                                    ( PRel(Gt, _1, _3) )
# 596 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 253 "src/plugins/aorai/promelaparser_withexps.mly"
                                                    ( PRel(Le, _1, _3) )
# 604 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 254 "src/plugins/aorai/promelaparser_withexps.mly"
                                                    ( PRel(Ge, _1, _3) )
# 612 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 255 "src/plugins/aorai/promelaparser_withexps.mly"
                                                    ( PRel(Neq,_1, _3) )
# 620 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 256 "src/plugins/aorai/promelaparser_withexps.mly"
                         ( PRel(Neq,_1, PCst(IntConstant "0")) )
# 627 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'logic_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 262 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PBinop(Badd, _1 , _3))
# 635 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation) in
    Obj.repr(
# 264 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PBinop(Bsub,_1,_3) )
# 643 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'arith_relation_mul) in
    Obj.repr(
# 265 "src/plugins/aorai/promelaparser_withexps.mly"
                             ( _1 )
# 650 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 271 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PBinop(Bdiv,_1,_3) )
# 658 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 273 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PBinop(Bmul,_1,_3) )
# 666 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'arith_relation_mul) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 275 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PBinop(Bmod,_1,_3) )
# 674 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access_or_const) in
    Obj.repr(
# 276 "src/plugins/aorai/promelaparser_withexps.mly"
                          ( _1 )
# 681 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'arith_relation_mul))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 280 "src/plugins/aorai/promelaparser_withexps.mly"
                      ( PCst(IntConstant _1) )
# 688 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 282 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PUnop (Uminus, PCst (IntConstant _2)) )
# 695 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access) in
    Obj.repr(
# 283 "src/plugins/aorai/promelaparser_withexps.mly"
                 ( _1 )
# 702 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'arith_relation) in
    Obj.repr(
# 284 "src/plugins/aorai/promelaparser_withexps.mly"
                                                       ( _2 )
# 709 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_or_const))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'access) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 288 "src/plugins/aorai/promelaparser_withexps.mly"
                                           ( PField (_1,_3) )
# 717 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access_array) in
    Obj.repr(
# 289 "src/plugins/aorai/promelaparser_withexps.mly"
                       (_1)
# 724 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access))
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 293 "src/plugins/aorai/promelaparser_withexps.mly"
            ( PArrget(_1,_3) )
# 732 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_array))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'access_leaf) in
    Obj.repr(
# 294 "src/plugins/aorai/promelaparser_withexps.mly"
                      (_1)
# 739 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_array))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'access) in
    Obj.repr(
# 297 "src/plugins/aorai/promelaparser_withexps.mly"
                              ( PUnop(Ustar,_2) )
# 746 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_leaf))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 3 : string) in
    let _4 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 298 "src/plugins/aorai/promelaparser_withexps.mly"
                                                               ( PPrm(_1,_4) )
# 754 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_leaf))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 299 "src/plugins/aorai/promelaparser_withexps.mly"
                        ( PVar _1 )
# 761 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_leaf))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 1 : 'access) in
    Obj.repr(
# 300 "src/plugins/aorai/promelaparser_withexps.mly"
                                               ( _2 )
# 768 "src/plugins/aorai/promelaparser_withexps.ml"
               : 'access_leaf))
(* Entry promela *)
