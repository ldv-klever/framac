  ...
  let infer t =
    ...
    | TUnOp (unop, t') ->
      ...
      (match unop with
       ...
       | Neg _ | BNot -> dup ctx_res)

    | TBinOp ((PlusA _ | MinusA _ | Mult _ | Div _ | Mod _ | Shiftlt _ | Shiftrt), t1, t2)
      ->
      let i = Interval.infer t in
    ...
    | TOffsetOf _ -> Error.not_yet "field offset"
    | Toffset_min _ | Toffset_max _ -> Error.not_yet "AstraVer offset"
    | Tpif _ -> Error.not_yet "predicate in conditional"
